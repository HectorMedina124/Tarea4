...
public class IniciarSesion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pass=view.findViewById(R.id.ContraseñaIn);
        pass2=pass.getEditText();
        email2=email.getEditText();
        mAuth = FirebaseAuth.getInstance();
        btn= view.findViewById(R.id.btnIn);
        txtR=view.findViewById(R.id.txtReg);
        fCon=view.findViewById(R.id.fPassIn);
        pb=view.findViewById(R.id.progressBarIn);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!email2.getText().toString().isEmpty()&& !pass2.getText().toString().isEmpty()) {
                    pb.setVisibility(View.VISIBLE);

                    System.out.println("---------------------------------------------------------------");
                    System.out.println("Usuario" + email2.getText().toString() + " contraseña " + pass2.getText().toString());
                    mAuth.signInWithEmailAndPassword(email2.getText().toString(), pass2.getText().toString())
                            .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(getActivity(), "Fallo en inicio de sesion",
        ...
        fCon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment f=new ContraseniaOlvidada();
                getActivity().getSupportFragmentManager().beginTransaction().add(R.id.content_main,f).commit();
            }
        });
